...
class StoreStudentNew extends FormRequest
{
    /**
    ...
    public function messages(): array
    {
        return [
            ...
            'survey.required' => 'Please answer all the questions',
            'survey.array' => 'Please answer all the questions',
            'survey.*.integer' => 'Please answer all the questions',
            'survey.*.required' => 'Please answer all the questions',
        ];
    }
}
